#ifndef PHASE_160MHZ_VMM_CALIBRATION_HPP
#define PHASE_160MHZ_VMM_CALIBRATION_HPP
...
class Phase160MHzVmmCalibration
{
public:
    Phase160MHzVmmCalibration(nsw::FEBConfig t_config, const std::vector<int>& t_input);
