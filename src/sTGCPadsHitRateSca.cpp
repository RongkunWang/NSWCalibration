...
void nsw::sTGCPadsHitRateSca::setupTree() {
  ...
  m_sector = nsw::guessSector(m_app_name);
  ...
  m_rtree->Branch("sector",      &m_sector);
...
void nsw::sTGCPadsHitRateSca::checkThresholdAdjustment(const std::uint32_t thr, const int adj) const {
